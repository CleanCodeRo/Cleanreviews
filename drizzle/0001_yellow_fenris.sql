ALTER TABLE "comments" ADD COLUMN "user_id" integer NOT NULL;--> statement-breakpoint
ALTER TABLE "comments" ADD COLUMN "post_id" integer NOT NULL;--> statement-breakpoint
DO $$ BEGIN
